        ...
        case 'init_templates':
            ...
            $tpls = [
                ...
                [
                    ...
                    'categoria' => 'bb',
                    'oggetto' => 'Ardy Lab — I vostri ospiti se ne innamorano e se lo portano a casa | Proposta',
                    'corpo' => "Gentile {{nome}},\n\nmi chiamo Michela Panella, fondatrice di Ardy Lab, bottega artigianale di Roma EUR specializzata nel restauro di mobili antichi e nella produzione di complementi d'arredo unici.\n\nVi scrivo per una proposta pensata per i B&B come il vostro: si chiama Galleria Diffusa.\n\n— Arrediamo le vostre camere con pezzi unici, restaurati e rigenerati a mano; restano di nostra proprietà, in comodato: voi non spendete nulla in arredo\n— Accanto a ogni pezzo c'è un QR code: l'ospite lo inquadra col telefono e si apre la storia dell'oggetto (audio, materiali, certificato di autenticità)\n— Se l'ospite se ne innamora, può acquistarlo o ordinarne uno su misura: voi guadagnate una commissione su ogni vendita; a logistica e pagamenti pensiamo noi\n\nPer voi è un'esperienza unica da offrire ai vostri ospiti, senza costi di arredamento e con un ricavo in più.\n\nTutti i dettagli e una chat dove fissare un appuntamento nel nostro laboratorio: https://ardy-lab.it/galleria-diffusa\n\nSarei felice di incontrarvi per mostrarvi qualche esempio concreto.\n\nCordiali saluti,\nMichela Panella\nArdy Lab · ardy-lab.it · +39 379 375 6437"
                ],
            ];
