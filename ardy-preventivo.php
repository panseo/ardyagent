...
.firma-intro { font-size: 10pt; margin-bottom: 12px; }
...
.validita { font-size: 10pt; font-weight: 700; margin-top: 12px; padding: 8px 14px; background: #f5f5f5; border-left: 4px solid #111; }
