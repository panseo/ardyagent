...
- Un arredo che racconta la sua storia
- Trasforma una poltrona in un'esperienza per i tuoi ospiti

**Preheader:** Oggetti unici restaurati, zero costi di arredo e una commissione su ogni vendita per il tuo B&B.

---

## Corpo email (HTML/testo)
...
1. **Arrediamo il tuo B&B** con oggetti unici, restaurati e rigenerati a mano.
   Restano di nostra proprietà, in comodato: **tu non spendi nulla in arredo**.
...
3. Se l'ospite se ne innamora, può **comprarlo o ordinarne uno su misura** dal
   telefono. E tu **guadagni una commissione** su ogni vendita. A logistica e
   pagamenti pensiamo noi.

Per te significa stanze più belle, un arredo che nessun altro ha e un'esperienza
che i tuoi ospiti si ricordano (e raccontano) — senza costi e senza pensieri
tecnici, con un ricavo in più su ogni vendita.
...
A presto,
Michela — Ardy Lab
Restauro e rigenerazione mobili · Roma EUR · ardy-lab.it
...
- **CTA principale** = il link alla pagina, dove la webchat di Sole è già attiva
  in "modalità partner B&B" (la riconosce dall'URL). Lì il B&B può: chiedere
  info, **fissare l'appuntamento in laboratorio** (Sole usa il calendario reale
  di Michela) ed essere invitato a chiamarla. Sole può dire che c'è una
  **commissione**, ma **non la percentuale**: quella la concorda Michela, a voce.
- **Numero in firma (+39 379 375 6437):** è il numero di Sole (eSIM sul telefono
  di Michela). Su WhatsApp risponde Sole h24; alle **chiamate vocali** risponde
  Michela **solo se quella eSIM è una linea mobile normale abilitata alle
  chiamate** (di norma sì). Se invece il numero è collegato solo all'API
